...
lapply(unique(allDat$ECOREGION), stecfEffortAreaPlot, type = "COUNTRY", fig.save = TRUE, fig.plot = FALSE, fig.width = 15, fig.height = 10, text.size = 7) 
